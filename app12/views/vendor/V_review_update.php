        ...
        <div id="main" class="wrapper wrapper-content animated fadeInRight">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-1">
                    <h3 class="content-header-title"><?= lang("Verifikasi Data Update", "Verifikasi Data Update") ?></h3>
                </div>
                <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><?= lang("Verifikasi Update Data Supplier", "Verifikasi Update Data Supplier") ?>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-top-border no-hover-bg" role="tablist">
                                <li role="nav-item" class="active" id="slka"><a href="#home" class="nav-link" aria-controls="dataumum" role="tab" data-toggle="tab"><?= lang("SLKA", "SLKA") ?></a></li>
                                ...
                                <li role="nav-item"><a href="#profile3" class="nav-link" aria-controls="datalegal" role="tab" data-toggle="tab"><?= lang("Pengurus", "Management") ?></a></li>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <span class="col-sm-4 control-label" id="PREFIX" for="PREFIX"><?php echo(isset($all1[0]["PREFIX"]) != false ? $all1[0]["PREFIX"] : '') ?>
                                                                        </span>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <label class="col-sm-6 control-label" for="NAMA"><?= lang("Nama Perusahaan", "Company Name"); ?></label>
                                                                        <span class="col-sm-4 control-label" id="NAMA" for="NAMA"><?php echo(isset($all1[0]->NAMA) != false ? $all1[0]->NAMA : '') ?></span>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <label class="col-sm-6 control-label" for="SUFFIX"><?= lang("Klasifikasi Perusahaan", "Suffix"); ?></label>
                                                                        <span class="col-sm-4 control-label" id="SUFFIX" for="SUFFIX"><?php echo(isset($all1[0]->SUFFIX) != false ? $all1[0]->SUFFIX : '') ?></span>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <label class="col-sm-6 control-label" for="KATEGORI"><?= lang("Kualifikasi Perusahaan", "Supplier Category"); ?></label>
                                                                        <span class="col-sm-4 control-label" id="KATEGORI" for="KATEGORI">l<?php echo(isset($all1[0]->KATEGORI) != false ? $all1[0]->KATEGORI : '') ?></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="profile6">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <!-- <table id="filetable" class="table table-striped table-bordered zero-configuration" width="100%">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped">
                                                            ...
                                                            <th><center><?= lang('Jenis File', 'File Type') ?></center></th>
                                                            <th><center><?= lang('Keterangan', 'Description') ?></center></th>
                                                            <th><center>File</center></th>
                                                            <th><center><center><?= lang("Aksi", "Action") ?></center></center></th>
                                                            </tr>
                                                            </thead>
                                                    ...
                                                    <div class="card-footer border-1 text-muted mt-2">
                                                        <div class="row m-b">
                                                            <div class="col-md-5"></div>
                                                            <div class="col-md-3 text-center">
                                                                ...
                                                                <button class="btn btn-primary"  onclick="modal_komen()"><i class="fa fa-envelope"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <form class="modal-content" id="checklist_app">
            ...
            <div class="modal-body" style="overflow: auto">
                <div class="ibox-content">
                    <input type="hidden" name="id_vendor" class="act_id" id="ck_id_vendor">
                    <div class="row">
                        <div class="col-sm-12">
        ...
        <form class=" modal-content" id="approve_mdl">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    <input name="id" class="act_id" hidden>
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative has-icon-left">
                            <textarea placeholder="Isi komentar anda" class="form-control" rows="5" name="note" class="note"></textarea>
        ...
        <div class=" modal-content">
            <div class="content-body">
                ...
                <div class="modal-body chat-application" style="padding:0px">
                    <section class="chat-app-window" style="max-height: 300px;">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <label id="label_kirim" class="control-label" for="field-1" style="color:rgb(217, 83, 79)">*</label>
                        <div class="position-relative has-icon-left">
                            <textarea placeholder="Isi komentar anda" class="form-control" rows="5" name="note" required class="note"></textarea>
                            <div class="form-control-position">
                                <i class="fa fa-file"></i>
                            </div>
                        </div>
...
<script>
    $(function () {
        ...
        $('#checklist_app2').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('vendor/review_update/checklist_app2') ?>',
        ...
        $('#csms').click(function (e) {
            ...
            $.ajax({
                url: "<?= base_url('vendor/review_update/get_csms') ?>",
                data: obj,
                type: "POST",
                cache: "false",
        ...
        $("#check_list_data #kirim_email_data").click(function () {
            swal({
                ...
                $.ajax({
                    url: "<?= base_url('vendor/review_update/checklist_app') ?>/",
                    type: "POST",
                    data: $('#checklist_app').serialize(),
                    dataType: "JSON",
        ...
        $('#approve_mdl').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('vendor/review_update/change_btn/1') ?>',
        ...
        $('#reject_mdl').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('vendor/review_update/change_btn/0') ?>',
        ...
        var table = $('#tbl').DataTable({
            "ajax": {
                "url": "<?= base_url('vendor/review_update/show') ?>",
                "dataSrc": ""
            },
            "data": null,
            "searching": true,
    ...
    function add(id, id_vendor) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= site_url('vendor/review_update/get_data/'); ?>" + id,
            data: "",
            cache: false,
            processData: false,
            contentType: false,
            success: function (res)
            {
                if (res != false)
                {
                    ...
                    $('#address_slka').text(" : " + res[0]["GEN"][5]);
                    $('#fax_slka').text(" : " + res[0]["GEN"][6]);
                    $('#telp_slka').text(" : " + res[0]["GEN"][7]);
    ...
    function check_list() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url('vendor/review_update/getlist/') ?>' + id_vendor,
    ...
    function tbl(id)
    {
        ...
        var tabel = $('#datakontakperusahaan').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/datakontakperusahaan/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "paging": false,
        ...
        var tabel2 = $('#alamatperusahaan').DataTable({
            "ajax": {
                url: '<?= base_url('vendor/review_update/alamatperusahaan/') ?>' + id,
                "dataSrc": ""
            },
            "searching": false,
            "paging": false,
        ...
        var tabel3 = $('#dataakta').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/dataakta/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "scrollX": true,
        ...
        var tabel4 = $('#datasertifikasi').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/show_datasertifikasi/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "scrollX": true,
        ...
        var tabel5 = $('#daftarjasa').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/daftarjasa/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "scrollCollapse": true,
        ...
        var tabel6 = $('#daftarbarang').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/daftarbarang/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "scrollX": true,
        ...
        var tabel7 = $('#dataDewanDireksi').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/show_company_management/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "data": null,
        ...
        var tabel8 = $('#databank').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/show_vendor_shareholders/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "data": null,
        ...
        var tabel9 = $('#neraca_keuangan_tabel').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/show_financial_bank_data/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "data": null,
        ...
        var tabel10 = $('#daftar_rekening_bank').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/show_vendor_bank_account/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "data": null,
        ...
        var tabel11 = $('#tabelsertifikasi').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/show_certification/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "data": null,
        ...
        var tabel12 = $('#data_pengalaman').DataTable({
            ajax: {
                url: '<?= base_url('vendor/review_update/show_experience/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "data": null,
...
//    }
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('vendor/review_update/filter_data'); ?>",
            data: obj,
            cache: false,
            success: function (res)
            {
    ...
    function modal_komen(type) {
        ...
        $.ajax({
                type: 'POST',
                url: '<?= base_url('vendor/review_update/comment/') ?>',
                data: obj,
                success: function (m) {                    
                        $('#message').html(m);
                        $('#type_msg').val(type)
