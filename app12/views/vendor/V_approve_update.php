        ...
        <div id="main" class="wrapper wrapper-content animated fadeInRight">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-1">
                    <h3 class="content-header-title"><?= lang("Review and Approve Update SLKA", "Review and Approve Update SLKA") ?></h3>
                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table id="tbl" class="table table-striped table-bordered zero-configuration display" cellspacing="0" width="100%">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-top-border no-hover-bg" role="tablist">
                                    <li role="nav-item" class="active"><a href="#home" class="nav-link" aria-controls="dataumum" role="tab" data-toggle="tab"><?= lang("SLKA", "General Data") ?></a></li>
                                    <li role="nav-item"><a href="#profile" id="data_umum" class="nav-link" aria-controls="datalegal" role="tab" data-toggle="tab"><?= lang("Data Umum", "SLKA") ?></a></li>
        ...
        <form class=" modal-content" id="approve_mdl">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
					...
					<!-- <input type="hidden" name="id_vendor" class="id_vendor">
                    <input type="hidden" name="email" class="email"> -->
                    <input type="hidden" name="statusnya" value="7">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary"><?= lang("Setujui", "Approve") ?></button>
            </div>
        </form>
    </div>
</div>
        ...
        <form class=" modal-content" id="reject_mdl" novalidate="novalidate" action="javascript:;">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    ...
                    <input type="hidden" name="statusnya" value="15">
                    <div class="form-group">
...
//        document.getElementById("approve_mdl").reset();
		var nama = $('#NAMA').html();
...
//        document.getElementById("reject_mdl").reset();
    ...
    $(function () {
        ...
        $('#approve_mdl').on('submit', function (e) {
          var xmodalx = modal_start($("#modal_app").find(".modal-content"));
            e.preventDefault();
            $.ajax({
                type: 'POST',
                url: '<?= base_url('vendor/approve_update/change_btn') ?>',
                ...
                success: function (m) {
				  ...
				  if (js.update == true ){
					 msg_info('Approve Berhasil'); 
					  ...
					  msg_danger('Approve Gagal - Silahkan cek koneksi Server JDE');
                  }
                ...
                {
                    stop(xmodalx);
                    msg_danger("Gagal", "Oops,Terjadi kesalahan pengiriman data");
                },
				timeout: 60000
            });
        });
        ...
        var table = $('#tbl').DataTable({
            "ajax": {
                "url": "<?= base_url('vendor/approve_update/show') ?>",
                "dataSrc": ""
            },
            "data": null,
            "searching": true,
...
//        iwan
        $.ajax({
            type: "POST",
            url: "<?= site_url('vendor/approve_update/get_data/'); ?>" + id,
            data: "",
            cache: false,
            processData: false,
            contentType: false,
                ...
                if (res != false) {
                    ...
                    $('.demo3').click(function () {
                        swal({
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo site_url('vendor/approve_update/approve'); ?>",
                                data: obj,
                                cache: false,
                                success: function (res)
                                {
                    ...
                    $('.demo2').click(function () {
                        swal({
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo site_url('vendor/approve_update/reject'); ?>",
                                data: obj,
                                cache: false,
                                success: function (res)
                                {
    ...
    function tbl(id)
    {
        ...
        var tabel = $('#datakontakperusahaan').DataTable({
            ajax: {
                url: '<?= base_url('vendor/approve_update/datakontakperusahaan/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            // "scrollX": true,
        ...
        var tabel11 = $('#tabelsertifikasi').DataTable({
            ajax: {
                url: '<?= base_url('vendor/approve_update/show_certification/') ?>' + id,
                dataSrc: ''
            },
            "searching": false,
            "data": null,
