                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="row" style="margin-top: 10px">
                        ...
                        <div class="col-sm-6 row text-right">
                            <div class="col-md-7">
                              <a target="_blank" href="<?= base_url('procurement/msr/inquiry') ?>?user=<?= $r->ID_USER ?>" class="btn btn-block btn-sm btn-primary"> Assignment <?= $this->approval_lib->getMsrAssignment($r->ID_USER)->num_rows() ?> </a>
                            </div>
                            <div class="col-md-5">
                              <a target="_blank" href="<?= base_url('approval/ed') ?>?user=<?= $r->ID_USER ?>" class="btn btn-block btn-sm btn-danger"> ED <?= $this->approval_lib->getAssignmentAgreement($r->ID_USER) ?> </a>
                            </div>
                        </div>
                      </div>
                      <?php
