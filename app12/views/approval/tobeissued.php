  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-1">
         <h3 class="content-header-title">ED Issuance</h3>
      </div>
      <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url() ?>/home/">Home</a></li>
            <li class="breadcrumb-item">ED Issuance</li>
          </ol>
        </div>
      </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <table id="tbl" class="table table-striped table-bordered table-fixed-column order-column dataex-lr-fixedcolumns table-hover table-no-wrap display" width="100%">
                          ...
                          <tbody>
                            <?php
                              $no=1;
                              foreach ($greetings['tobeIssued']->result() as $msr) :
                            ...
                            <tr>
                              <td><?=$no++?></td>
                              <td><?= str_replace('OR', 'OQ', $ori->msr_no) ?></td>
                              <td><?=$ed->subject?></td>
                              ...
                              <td class="text-center">
                                <a href="<?=base_url('approval/approval/viewbled/'.$msr->data_id.'/'.$msr->approval_id)?>" class="btn btn-sm btn-info">Process</a>
                              </td>
                            </tr>
                            <?php endforeach;?>
                          </tbody>
