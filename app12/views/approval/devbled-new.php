...
<div class="app-content content">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="row"> 
                              ...
                              <input  class="form-control tgl-aja" id="bid_validity" name="bid_validity" id="bid_validity" value="<?=@$ed->bid_validity?>">
                              </div>
                            </div>
                          </div>
                          <!-- right side -->
  ...
  function bid_bond_type_change() {
    ...
    {
      $("#bid_bond,#bid_bond_validity").attr('readonly','');
      $("#bid_bond,#bid_bond_validity").val(null);
    }
    else
    {
      $("#bid_bond,#bid_bond_validity").removeAttr('readonly');
    }
  }
