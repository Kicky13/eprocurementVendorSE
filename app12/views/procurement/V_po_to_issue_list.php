  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-1">
         <h3 class="content-header-title">Agreement to be Issued</h3>
      </div>
      <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?= lang("Agreement to be Issued", "Agreement to be Issued") ?></li>
          </ol>
        </div>
      </div>
    </div>
                          ...
                          if (count($pos) > 0):
                            foreach ($pos as $i => $po) :
                              ...
                              // $eq = $this->db->where(['msr_no'=>$awarder->data_id])->get('t_eq_data')->row();
                               ...
                               $company = $this->db->where(['ID_COMPANY'=>$msr->id_company])->get('m_company')->row();
                            ?>
                              <tr>
                                <td><?= @$i + 1 ?></td>
                                <td><?= @$po->po_no?></td>
                                ...
                                <td class="text-center">
                                  ...
                                  <a href="<?= base_url('procurement/purchase_order/toIssue/'.$po->id) ?>" class="btn btn-sm btn-info">
                                    Process
                                  </a>
                                  <?php /* endif */ ?>
                                </td>
