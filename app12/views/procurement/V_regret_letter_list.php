  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-1">
         <h3 class="content-header-title">Acceptance of Award Recommendation</h3>
      </div>
      <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url() ?>/home/">Home</a> </li>
            <li class="breadcrumb-item active"><?= lang("Regret Letter to be Send", "Regret Letter to be Send") ?></li>
          </ol>
        </div>
      </div>
    </div>
                          ...
                          if (count($letters) > 0):
                            ...
                            ?>
                              <tr>
                                ...
                                <?php if ($letter->regret_letter_id): ?>
<a href="<?= base_url('procurement/regretLetter/show/'.$letter->regret_letter_id) ?>" role="button" class="btn btn-sm btn-info">Detail</a>
                                <?php else: ?>
<a href="<?= base_url('procurement/regretLetter/send/'.$letter->bl_detail_id) ?>" role="button" class="btn btn-sm btn-success">Send</a>
                                <?php endif; ?>
                                </td>
                              </tr>
                              <?php endforeach; ?>
