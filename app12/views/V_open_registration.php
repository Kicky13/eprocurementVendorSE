                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <fieldset class="form-group">
                          <label for="roundText"><?= lang("Tanggal Pembukaan", "Opening Date") ?></label>
                          <input  maxlength="20" type="text" class="form-control" id="search_open">
                        </fieldset>
                    </div>
                    <div class="col-md-12">
                        <fieldset class="form-group">
                          <label for="roundText"><?=lang("Tanggal Penutupan","Closing Date")?></label>
                          <input  maxlength="20" type="text" class="form-control" id="search_close">
                        </fieldset>
                    </div>
                    <div class="col-md-12">
                        <fieldset class="form-group">
