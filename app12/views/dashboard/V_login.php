...
<html lang="en" data-textdirection="ltr" class="loading">
    <head>
        ...
        <title>Login Dashboard Supreme</title>
                                ...
                                <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                    <div class="card-header border-0">
                                        ...
                                        <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                                            <span style="font-weight:bold"><?= lang("Login Akun Dashboard", "Login Dashboard Account") ?></span>
                                        </h6>
                                    </div>
        ...
        <script>
            ...
            $(function () {
                ...
                $(".refresh").click(function () {
                    jQuery.ajax({
                        type: "POST",
                        url: "<?= base_url(); ?>" + "dashboard/log_in/captcha_refresh",
                ...
                $('#login').on('submit', function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url('dashboard/log_in/cek_login') ?>',
                        data: obj,
                        success: function (m) {
                            console.log(m);
                            if (m == 'sukses') {
