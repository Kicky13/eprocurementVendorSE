        ...
        <div id="main" class="wrapper wrapper-content animated fadeInRight">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-1">
                    <h3 class="content-header-title"><?= lang("Master Perusahaan", "Company Master") ?></h3>
                </div>
                <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><?= lang("Master Perusahaan", "Company Master") ?>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            <label class="col-4 control-label" for="no_akta">
                                <?= lang("ID Perusahaan", "Company ID"); ?>
                            </label>
                            <div class="col-8">
                                <input type="text" class="form-control" id="id_com" name="id_com">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-4 control-label" for="no_akta">
...
$(function(){
    ...
    var table = $('#tbl').DataTable({
        "ajax": {
            "url": "<?= base_url('setting/master_company/show') ?>",
            "dataSrc": ""
        },
        scrollX: true,
        scrollY: '300px',
        ...
        fixedColumns: {
            ...
            "columns": [
                ...
                {title: "<center><?= lang("&nbsp&nbsp&nbsp&nbspAksi&nbsp&nbsp&nbsp&nbsp", "&nbsp&nbsp&nbsp&nbspAction&nbsp&nbsp&nbsp&nbsp") ?></center>"}
            ],
            "columnDefs": [
        ...
        $('#tbl tbody').on('click', 'tr .update', function () {
            ...
            $('#abb_com').val(data[3]);
            var stat=0;
            if(data[4] == "AKTIF" || data[4] == "ACTIVE")
                $('.act').attr('checked',true);
            else
                $('.nact').attr('checked',true);
            $('#modal_edit .modal-title').html("<?= lang("Perbarui data Perusahaan", "Update Company") ?>");
            $('#add').hide();
            $('#update').show();
            $('#update').val(this.id);
...
//                console.log(obj);
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('setting/master_company/add_data'); ?>",
                    data: obj,
                    cache: false,
