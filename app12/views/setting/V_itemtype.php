    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-1">
                <h3 class="content-header-title"><?= lang("Item Type", "Item Type") ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?= lang("Item Type", "Item Type") ?></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <form id="formtambah" class="form-horizontal">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="form-label"><?= lang("Kode Item Type", "Item Type Code") ?></label>
                    <div class="controls">
                        <input type="text" name="id_acc" id="id_acc" class="form-control" maxlength="1" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label"><?= lang("Deskripsi", "Description") ?></label>
                    <div class="controls">
                        <input type="text" name="acc_desc" id="acc_desc" class="form-control" maxlength="20" required>
                    </div>
                </div>
                <div class="form-group">
...
$(document).ready(function() {
  $(document).on('submit', '#formtambah', function (e) {
    e.preventDefault();
    $.ajax({
      url: '<?= base_url('setting/Itemtype/add'); ?>',
      dataType: 'json',
      type: 'POST',
      data: $(this).serialize(),
    ...
    $.ajax({
    type: 'GET',
    url: '<?= base_url('setting/Itemtype/get/') ?>' + id,
    success: function (res) {
        ...
        $('#id_acc').val(d.ID_ITEMTYPE);
        $('#acc_desc').val(d.ITEMTYPE_DESC);
        if (d.STATUS == "0"){
          document.getElementById("aktif").checked = true;
        } else {
    ...
    var table=$('#tbl').DataTable({
      ajax: {
          url: '<?= base_url('setting/Itemtype/show') ?>',
          dataSrc: ''
      },
      scrollX: true,
      scrollY: '300px',
      ...
      columns: [
          ...
          {title: "<center><?= lang('Kode Item Type', 'Item Type Code') ?></center>"},
