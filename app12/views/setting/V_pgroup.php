        ...
        <div id="main" class="wrapper wrapper-content animated fadeInRight">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-1">
                    <h3 class="content-header-title"><?= lang("Master Grup Procurement", "Procurement Group Master") ?></h3>
                </div>
                <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><?= lang("Master Grup Procurement", "Procurement Group Master") ?>
                            </li>
                        </ol>
                    </div>
                </div>
                                                ...
                                                <table id="tbl" class="table table-striped table-bordered zero-configuration" width="100%">
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th><center><?= lang('Grup', 'Group') ?></center></th>
...
$(function(){
    ...
    var table = $('#tbl').DataTable({
        "ajax": {
            "url": "<?= base_url('setting/procurement_group/show') ?>",
            "dataSrc": ""
        },
        scrollX: true,
        scrollY: '300px',
...
//                console.log(obj);
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('setting/procurement_group/add_data'); ?>",
                    data: obj,
                    cache: false,
...
function delete_dt(id)
{
    swal({
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url('setting/procurement_group/delete_data/') ?>',
            data: obj,
