        ...
        <div id="main" class="wrapper wrapper-content animated fadeInRight">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-1">
                    <h3 class="content-header-title"><?= lang("Master Cost Center", "Cost Center Master") ?></h3>
                </div>
                <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><?= lang("Master Cost Center", "Cost Center Master") ?>
                            </li>
                        </ol>
                    </div>
                </div>
                                                ...
                                                <table id="tbl" class="table nowrap table-striped table-bordered zero-configuration" width="100%">
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th><center><?= lang('ID CostCenter', 'CostCenter ID') ?></center></th>
            ...
            <div class="modal-body col-12">
                <form id="com_form" class="form" action="javascript:;"  novalidate="novalidate">
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            <label class="col-4 control-label" for="no_akta">
                                <?= lang("ID Cost Center", "ID Cost Center"); ?>
                            </label>
                            <div class="col-8">
...
$(function(){
    ...
    var table = $('#tbl').DataTable({
        "ajax": {
            "url": "<?= base_url('setting/master_costcenter/show') ?>",
            "dataSrc": ""
        },
        scrollX: true,
        scrollY: '300px',
        ...
        fixedColumns: {
            ...
            "columns": [
                ...
                {title: "<center><?= lang('ID CostCenter', 'ID CostCenter') ?></center>"},
        ...
        $('#tbl tbody').on('click', 'tr .update', function () {
            ...
            $('#modal_edit .modal-title').html("<?= lang("Perbarui data Perusahaan", "Update Bank Company") ?>");
            $('#add').hide();
            $('#update').show();
            $('#update').val(this.id);
...
//                console.log(obj);
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('setting/master_costcenter/add_data'); ?>",
                    data: obj,
                    cache: false,
...
function add()
{
    ...
    $('#modal_edit').modal('show');
    $('#modal_edit .modal-title').html("<?= lang("Tambah Data Perusahaan", "Add Company Data") ?>");
    document.getElementById("com_form").reset();
    $('#update').val("0");
    $('#add').show();
    $('#update').hide();
...
function delete_dt(id,cost)
{
    swal({
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url('setting/master_costcenter/delete_data/') ?>',
            data: obj,
