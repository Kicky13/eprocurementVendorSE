    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-1">
                <h3 class="content-header-title"><?= lang("Freight", "Freight") ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?= lang("Freight", "Freight") ?></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <form id="formtambah" class="form-horizontal">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="form-label"><?= lang("Kode Freight", "Freight Code") ?></label>
                    <div class="controls">
...
$(document).ready(function() {
  $(document).on('submit', '#formtambah', function (e) {
    e.preventDefault();
    $.ajax({
      url: '<?= base_url('setting/Freight/add'); ?>',
      dataType: 'json',
      type: 'POST',
      data: $(this).serialize(),
    ...
    $.ajax({
    type: 'GET',
    url: '<?= base_url('setting/Freight/get/') ?>' + id,
    success: function (res) {
        ...
        $('#id_acc').val(d.ID_FREIGHT);
        $('#acc_desc').val(d.FREIGHT_DESC);
        if (d.STATUS == "0"){
          document.getElementById("aktif").checked = true;
        } else {
    ...
    var table=$('#tbl').DataTable({
      ajax: {
          url: '<?= base_url('setting/Freight/show') ?>',
          dataSrc: ''
      },
      scrollX: true,
      scrollY: '300px',
      ...
      columns: [
          ...
          {title: "<center><?= lang('Kode Freight', 'Freight Code') ?></center>"},
