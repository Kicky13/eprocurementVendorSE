        ...
        <div id="main" class="wrapper wrapper-content animated fadeInRight">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-1">
                    <h3 class="content-header-title"><?= lang("Master Inspeksi", "Inspection Master") ?></h3>
                </div>
                <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><?= lang("Master Inspeksi", "Inspection Master") ?>
                            </li>
                        </ol>
                    </div>
                </div>
                                                ...
                                                <table id="tbl" class="table table-striped table-bordered zero-configuration" width="100%">
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th><center><?= lang('ID Inspeksi', 'Inspection ID') ?></center></th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary white">
                <h4 class="modal-title"><?= lang("Tambah data Bank", "Add Inspection Bank Data") ?></h4>
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            <label class="col-4 control-label" for="no_akta">
                                <?= lang("ID Inspeksi", "Inspection ID"); ?>
                            </label>
                            <div class="col-8">
...
$(function(){
    ...
    var table = $('#tbl').DataTable({
        "ajax": {
            "url": "<?= base_url('setting/master_inspection/show') ?>",
            "dataSrc": ""
        },
        scrollX: true,
        scrollY: '300px',
        ...
        fixedColumns: {
            ...
            "columns": [
                ...
                {title: "<center><?= lang('ID Inspeksi', 'Inspection ID') ?></center>"},
        ...
        $('#tbl tbody').on('click', 'tr .update', function () {
            ...
            $('#modal_edit .modal-title').html("<?= lang("Perbarui data bank", "Update Inspection Bank Data") ?>");
            $('#add').hide();
            $('#update').show();
            $('#update').val(this.id);
...
//                console.log(obj);
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('setting/master_inspection/add_data'); ?>",
                    data: obj,
                    cache: false,
...
{
    console.log('tet');
    $('#modal_edit .modal-title').html("<?= lang("Tambah data bank", "Add Inspection Bank Data") ?>");
    document.getElementById("bank_form").reset();
    $('#update').val("0");
    $('#add').show();
    $('#update').hide();
...
function delete_dt(id)
{
    swal({
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url('setting/master_inspection/delete_data/') ?>',
            data: obj,
