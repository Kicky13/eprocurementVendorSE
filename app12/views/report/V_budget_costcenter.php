...
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>ast11/app-assets/vendors/css/tables/extensions/fixedHeader.dataTables.min.css">
                    ...
                    <div class="col-md-12">
                      <div class="table-responsive">
                        <table id="budget_table" class="table table-condensed table-striped" width="100%">
                          <thead>
                            <tr>
                              <th data-name="costcenter_id" data-data="costcenter_id" rowspan="2">Cost Center</th>
                              <th data-name="costcenter_desc" data-data="costcenter_desc"  rowspan="2">Cost Center Desc.</th>
...
<!-- 
<script src="<?= base_url() ?>ast11/app-assets/vendors/js/tables/datatable/dataTables.fixedHeader.min.js" type="text/javascript"></script>
-->
...
$('#budget_table').DataTable({
  ...
  "fixedHeader": true,
  "ajax" : {
    "url" : "<?= base_url('report/budget/dataCostCenter') ?>",
  },
  "columnDefs": [
    { "targets": [0],
      "render": function(data, type, row, meta) {
        if (type === 'display') {
          return '<a href="<?= base_url('report/budget/accSubsidiary') ?>?costcenter_id=' + data +'" target="_blank">' + data + '</a>';
        } 
    ...
    { "targets": [1],
      "render": function(data, type, row, meta) {
        if (type === 'display') {
          return '<a href="<?= base_url('report/budget/accSubsidiary') ?>?costcenter_id=' + row.costcenter_id +'" target="_blank">' + data + '</a>';
        } 
