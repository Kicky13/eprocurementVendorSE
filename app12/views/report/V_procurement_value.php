          ...
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
              <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active"><?= lang(strtoupper($doc_type)." - Procurement Value", strtoupper($doc_type)." - Procurement Value") ?></li>
                  </ol>
              </div>
          </div>
      </div>
...
$(document).ready(function() {
  ...
  $("#tbl_laporan").DataTable({
    ...
    ajax: {
      url: '<?= base_url('report/Procurement_value/send_datatable') ?>'+url_type,
      type:'POST',
      data: function(d){
    ...
    buttons: [
      {
        ...
        filename: 'Report Procurement Value ('+proc_type+')',
        exportOptions: {
          columns: [ 0, 1, 2, 3, 4 ]
        },
        customize: function (xlsx) {
          ...
          //insert
          var r1 = Addrow(1, [{ k: 'A', v: 'Report Procurement Value ('+proc_type+')' }, { k: 'B', v: '' }, { k: 'C', v: '' },  ]);
      ...
      },
      {
          text: 'PDF',
          extend: 'pdfHtml5',
          title : 'Report Procurement Value ('+proc_type+')',
          filename: 'Report Procurement Value ('+proc_type+')',
          exportOptions: {
            columns: [ 0, 1, 2, 3, 4 ]
          },
...
function get_detail(idnya){
  $("#tbl_laporan_detail").DataTable({
    ...
    ajax: {
      url: '<?= base_url('report/Procurement_value/send_datatable_detail') ?>'+url_type+idnya,
      type:'POST',
      data: function(d){
    ...
    buttons: [
      {
        ...
        text: 'Excel',
        title: 'Excel_Export_Title',
        filename: 'Report Procurement Value ('+proc_type+') - Detail',
        // exportOptions: {
        //   columns: [ 0, 1, 2, 3, 4 ]
        // },
        customize: function (xlsx) {
          ...
          //insert
          var r1 = Addrow(1, [{ k: 'A', v: 'Report Procurement Value ('+proc_type+') - Detail' }, { k: 'B', v: '' }, { k: 'C', v: '' },  ]);
      ...
      },
      {
          text: 'PDF',
          extend: 'pdfHtml5',
          title : 'Report Procurement Value ('+proc_type+') - Detail',
          filename: 'Report Procurement Value ('+proc_type+') - Detail',
