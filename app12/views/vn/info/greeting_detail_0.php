    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-12 col-12 mb-1">
                ...
                <h6 class="content-header-title">ENQUIRY DOCUMENT For<label class="pull-right">Refrence No
                        : <?= $bled_no ?></label></h6>
            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <p style="text-align:justify; text-justify:inter-word">
                                                                        ...
                                                                        invite <?= $this->session->userdata('NAME'); ?>
                                                                        to submit Bid Proposal subject tender.
                                                                        Should you desire to bid or unable to bid, we
                                                                        request you to confirm your participation or
                                                                        notify your withdraw
                                                                        by <?= dateToIndo(date('Y-m-d', strtotime($row->issued_date . ' +1 days'))) ?>
                                                                        .
                                                                        We trust the information contained in the
                                                                        Enquiry Document is sufficient to the
                                                                        preparation of your Bid Proposal and look
                                                                        forward for your participation.
                                                                        COMPANY reserves the right to reject any or all
                                                                        Bid Proposals without providing any reason
                                                                        thereof
                                                                    </p>
                                                                    <br/>
                                                                    <br/>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" class="form-horizontal open-this" enctype="multipart/form-data"
                      action="<?= base_url('vn/info/greetings/confirmation') ?>">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td colspan="3" style="text-align:justify; text-justify:inter-word">
                                    ...
                                    that we withdraw from further participation in the bidding process. We further
                                    confirm that we shall treat the Enquiry Document as confidential matter and only
                                    disclose to others such information as is necessary for the preparation of the Bid
                                    Proposal.
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <textarea class="form-control" required="" rows="3" name="reason"
                                      id="reason">--Other--</textarea>
                        </div>
                    </div>
                    <div class="form-group">
...
<script src="<?= base_url() ?>ast11/app-assets/vendors/js/pickers/dateTime/moment-with-locales.min.js"
        type="text/javascript"></script>
<script src="<?= base_url() ?>ast11/app-assets/vendors/js/pickers/dateTime/bootstrap-datetimepicker.min.js"
        type="text/javascript"></script>
