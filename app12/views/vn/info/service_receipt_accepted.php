                                                    ...
                                                    <tbody>
                                                        <?php foreach ($rs_service_receipt as $r_service_receipt) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?= dateToIndo($r_service_receipt->accepted_at) ?></td>
                                                                <td class="text-right">
                                                                    <a href="<?=base_url('vn/info/service_receipt/view/'.$r_service_receipt->id) ?>" class="btn btn-primary btn-sm">View</a>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
