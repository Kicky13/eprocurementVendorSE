    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-1">
                <h3 class="content-header-title"><?= lang("Master Klasifikasi Material", "Master Material Classicfication") ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?= lang("Klasifikasi Material", "Material Clasification") ?></li>
                    </ol>
                </div>
            </div>
        </div>
                                            ...
                                            <table id="tbl" class="table nowrap table-striped table-bordered table-fixed-column order-column dataex-lr-fixedcolumns table-hover display" width="100%">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th><center>Klasifikasi Material</center></th>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('material/classification/change') ?>',
                data: $('#form').serialize(),
                success: function (m) {
                    if (m == 'sukses') {
                        $('#modal').modal('hide');
    ...
    var table=$('#tbl').DataTable({
        ajax: {
            url: '<?= base_url('material/classification/show') ?>',
            dataSrc: ''
        },
        scrollX: true,
        scrollY: '300px',
        ...
        columns: [
            ...
            {title: "<center><?= lang('Klasifikasi Material', 'Material Classification') ?></center>"},
...
//        obj.types = new array();
//        if($('#type_goods').is(":checked")){
//            obj.types[1]="GOODS";
//        }
//
//        if($('#type_service').is(":checked")){
//            obj.types[2]="SERVICE";
//        }
//
//        if($('#type_consultation').is(":checked")){
//            obj.types[3]="CONSULTATION";
//        }
        ...
        $.ajax({
            type: "POST",
            url: "<?= site_url('material/classification/filter_data'); ?>",
            data: obj,
            cache: false,
    ...
    function update(id) {
        $.ajax({
            type: 'POST',
            url: '<?= base_url('material/classification/get/') ?>' + id,
