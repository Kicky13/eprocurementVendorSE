    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-1">
                <h3 class="content-header-title"><?= lang("Master UOM Service", "Master Service UOM") ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url() ?>/home/">Home</a></li>
                        <li class="breadcrumb-item active"><?= lang("Master Service", "Master Service") ?></li>
                        <li class="breadcrumb-item active"><?= lang("UOM Service", "Service UOM") ?></li>
                    </ol>
                </div>
            </div>
        </div>
                                            ...
                                            <table id="tbl" class="table table-striped table-bordered table-fixed-column order-column dataex-lr-fixedcolumns table-hover display" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><center><?= lang('Service UOM', 'Service UOM') ?></center></th>
        ...
        <form id="form">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="form-label"><?= lang('Service UOM', 'Service UOM') ?></label>
                    <div class="controls">
...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('material/service_uom/change') ?>',
                data: $('#form').serialize(),
                success: function (m) {
                    if (m == 'sukses') {
                        $('#modal').modal('hide');
    ...
    function get()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('material/service_uom/filter_data'); ?>",
            data: obj,
            cache: false,
    ...
    function update(id) {
        $.ajax({
            type: 'POST',
            url: '<?= base_url('material/service_uom/get/') ?>' + id,
    ...
    var table=$('#tbl').DataTable({
        ajax: {
            url: '<?= base_url('material/service_uom/show') ?>',
            dataSrc: ''
        },
        scrollX: true,
        scrollY: '300px',
