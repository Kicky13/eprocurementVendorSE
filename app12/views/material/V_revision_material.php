    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-1">
                <h3 class="content-header-title"><?= lang("Perubahan Material", "Material Revision") ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?= lang("Perubahan Material", "Material Revision") ?></li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="card-header">
                                        <div class="heading-elements">
                                            <h5 class="title pull-right">
                                                ...
                                                <!-- <a href="<?= base_url('material/Mregist_approval/') ?>" class=""><i class="fa fa-plus-circle"></i> <?= lang("Form Approval", "Form Approval") ?></a> -->
            ...
            <form class="form-horizontal m_registration" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="card-footer border-2 text-muted mt-2">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label" style="text-align: right;">
                                <?= lang("Unit Satuan*", "Unit of Measurement*") ?>
                            </label>
                            <div class="col-md-4">
    ...
    $(document).ready(function () {
        ...
        $('.m_registration').submit(function (e) {
            ...
            if( !messageLength.length ) {
              msg_danger("Empty item Long Desc !")
            } else if (messageLength.length > 500){
              msg_danger("Item Long Desc maximum length is 500 character !")
            } else {
        ...
        $("#myModal").on('shown.bs.modal', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $.each(res, function (index, el) {
                            ...
                            $('#classification').val();
                            // $('#semic_group').val(el.data2.EQPMENT_ID).select2({ width: '100%' });
                            ...
                            $('#m_uom').val(el.data2.UOM).select2({ width: '100%' });
            ...
            $("#semic_no").focusout(function(e) {
              ...
              if ($(this).val() != '') {
                if (semicx === $("#semic_no").val() && idnya != '') {
                  ...
                  $.ajax({
                    url: '<?= base_url('material/revision_material/check_semic') ?>',
                    type: 'POST',
                    dataType: 'json',
              ...
              if ($("#semic_group").val() != "") {
                ...
                var split_semic = semic_no.split('.');
                $.ajax({
                  url: '<?= base_url('material/revision_material/check_semic_group') ?>',
                  type: 'POST',
                  dataType: 'json',
                  data: {
            ...
            $('#form').on('submit', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url('material/revision_material/change') ?>',
                    data: $('#form').serialize(),
                    success: function (m) {
                        if (m == 'sukses') {
                            $('#modal').modal('hide');
        ...
        $('#tbl tfoot th').each(function (i) {
            var title = $('#tbl tfoot th').eq(i).text();
            if (title != '') {
        ...
        var table = $('#tbl').DataTable({
            "ajax": {
                "url": "<?= base_url('material/revision_material/datatable_registrasi_material') ?>",
                "dataSrc": ""
            },
            "scrollX": true,
            "paging": true,
