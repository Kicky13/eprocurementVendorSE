    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-1">
                <h3 class="content-header-title"><?= lang("Persetujuan Katalog", "Catalouging Approvement") ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?= lang("Persetujuan Katalog", "Catalouging Approvement") ?></li>
                    </ol>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('show.bs.modal', '#myModal', function(e){
      ...
      $.ajax({
        ...
        success: function(res){
          ...
          $.each(res, function(index, el) {
            ...
            $("#material_image").html('<a data-lightbox="lightbox" data-title="MATERIAL IMAGE" href="<?= base_url(); ?>upload/MATERIAL/img/ori/'+el.img1_url+'"><img src="<?= base_url(); ?>upload/MATERIAL/img/ori/'+el.img1_url+'"></a>')
            $("#material_drawing").html('<a data-lightbox="lightbox" data-title="MATERIAL IMAGE" href="<?= base_url(); ?>upload/MATERIAL/img/ori/'+el.img2_url+'"><img src="<?= base_url(); ?>upload/MATERIAL/img/ori/'+el.img2_url+'"></a>')
            ...
            if (el.file_url == "" || el.file_url == "-") {
              ...
              // var str = '<iframe frameborder="0" scrolling="no" width="100%" height="100%" src="<?= base_url(); ?>upload/MATERIAL/files/'+el.file_url+'" name="imgbox" id="imgbox"></iframe><br/>';
      ...
      $(document).on('click', '#save', function(e) {
        ...
        function(){
          ...
          var str = 'Material Name :'+$("#m_name").val()+'<br>'+
                    'UOM Material:'+$("#optmaterial_uom2").val()+'<br>'+
                    'Squence Group:'+$("#squence_group_name").val()+'<br>';
          $.ajax({
            url: '<?= base_url('material/Registration_spvuser_validation/approve_request_catalog') ?>',
            dataType: 'json',
            type: 'post',
            data: {
              idnya: idnya,
              note: 'Supervisor User Validation, '+str
            },
            success: function(res){
              window.location.href = "<?=base_url('material/registration_spvuser_validation')?>";
              // console.log(res);
            }
          })
        });
    ...
    var table = $('#tbl').DataTable({
        "ajax": {
            "url": "<?= base_url('material/Registration_spvuser_validation/datatable_persetujuan_katalog') ?>",
            "dataSrc": ""
        },
        "data": null,
        "searching": true,
