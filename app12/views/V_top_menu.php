            ...
            <div class="navbar-wrapper">
                <div class="navbar-header">
                    <ul class="nav navbar-nav flex-row">
                        ...
                        <li class="nav-item"><a href="index.html" class="navbar-brand"><img alt="Logo supreme" src="./ast11/img/logo-supreme2.png" class="brand-logo">                                
                    ...
                    <div id="navbar-mobile" class="collapse navbar-collapse">
                                            ...
                                            <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                                                ...
                                                <div id="accordionOne" role="tabpanel" aria-labelledby="headingOne" aria-expanded="true"
                                                    ...
                                                    <div class="card-content">
                                                        <p class="accordion-text text-small-3">Caramels dessert chocolate cake p.ry jujubes bonbon.
                                                ...
                                                <div id="accordionTwo" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="false"
                                                    ...
                                                    <div class="card-content">
                                                        <p class="accordion-text">Sugar plum bear claw oat cake chocolate jelly tiramisu
                                                            ...
                                                            cake. P.ry oat cake chupa chups.</p>
                                                    </div>
                                                </div>
                        ...
                        <ul class="nav navbar-nav float-right">
                            <li class="dropdown dropdown-language nav-item"><a id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true"
                                                                               aria-expanded="false" class="dropdown-toggle nav-link"><i class="flag-icon flag-icon-id"></i><span class="selected-language"></span></a>
                                <div aria-labelledby="dropdown-flag" class="dropdown-menu"><a href="#" class="dropdown-item"><i class="flag-icon flag-icon-gb"></i> English</a>
                                    <a href="#" class="dropdown-item"><i class="flag-icon flag-icon-id"></i> Indonesia</a>
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <small>
                                                        <time datetime="2015-06-11T18:29:20+08:00" class="media-meta text-muted">L. week</time>
                                                    </small>
                                                </div>
                                            </div>
                                        </a>
                                        <a href="javascript:void(0)">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <small>
                                                        <time datetime="2015-06-11T18:29:20+08:00" class="media-meta text-muted">L. month</time>
                                                    </small>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <li class="scrollable-container media-list">
                                            ...
                                            <div class="media">
                                                <div class="media-left">
                                                    <span class="avatar avatar-sm avatar-online rounded-circle">
                                                        <img src="./ast11/app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span>
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="media">
                                                <div class="media-left">
                                                    <span class="avatar avatar-sm avatar-online rounded-circle">
                                                        <img src="./ast11/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                                                </div>
                                                <div class="media-body">
