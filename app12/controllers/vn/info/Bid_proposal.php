<?php
class Bid_proposal extends CI_Controller
{
    public function __construct() {
        parent::__construct();        
        $this->load->helper('url');
        $this->load->library('session');        
        $this->load->model('vn/info/M_bid_proposal', 'mbp');
    ...
    public function index() {
        ...
        $data['menu'] = $dt;
        $this->template->display_vendor('vn/info/V_bid_proposal', $data);
    }    
/* ===========================================-------- API START------- ====================================== */
...
/* ===========================================-------- get data Table START------- ====================================== */
    ...
    public function show_perf($id)
    {
        $dt = array();        
        $k=0;            
        $this->output($dt);
    }
    public function show_asrnc($id)
    {
        $dt = array();        
        $k=0;            
        $this->output($dt);
