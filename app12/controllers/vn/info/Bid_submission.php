<?php
class Bid_submission extends CI_Controller
{
    public function __construct() {
        parent::__construct();        
        $this->load->helper('url');
        $this->load->library('session');        
        $this->load->model('vn/info/M_bid_submission', 'mbs');
    ...
    public function index() {
        ...
        $data['menu'] = $dt;
        $this->template->display_vendor('vn/info/V_bid_submission', $data);
    }    
/* ===========================================-------- API START------- ====================================== */
