...
class Company_type extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/M_company_type');
        $this->load->helper('global_helper');
    }

    public function index($id = null) {
        $get_menu = $this->M_vendor->menu();
        $get_company = $this->M_company_type->m_company();
        $data['doc_type'] = $id;
        $dt = array();
        ...
        $this->template->display('report/V_company_type', $data);
    }
    ...
    public function send_datatable_goods(){
      ...
      $send = $this->M_company_type->show_datatable_goods($dt);
      echo $send;
    ...
    public function send_datatable_detail_goods($idx){
      ...
      $send = $this->M_company_type->show_datatable_detail_goods($dt);
      echo $send;
      // echo json_encode($dt, JSON_PRETTY_PRINT);
    }
    ...
    public function send_datatable_services(){
      ...
      $send = $this->M_company_type->show_datatable_services($dt);
      echo $send;
      // echo json_encode($dt, JSON_PRETTY_PRINT);
    }
    ...
    public function send_datatable_detail_services($idx){
      ...
      $send = $this->M_company_type->show_datatable_detail_services($dt);
      echo $send;
      // echo json_encode($dt, JSON_PRETTY_PRINT);
    }
