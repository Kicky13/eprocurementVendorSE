...
class M_perform_itp_approval extends CI_Model {
  ...
  public function list_itp_onprogress(){
    ...
    ELSE b.description
    END as description, b.reject_step, v.note,
    h.itp_no, h.no_po, y.title, v.note, v.created_date
    ...
    jabatan,
    a.id,a.id_itp,b.user_roles,b.email_approve,b.edit_content, b.extra_case, b.email_reject,b.sequence,b.status_approve,
    b.description, b.reject_step, v.note,
    h.itp_no, h.no_po, y.title
    ");
  ...
  public function itp_doc_approval($data){
    ...
    $this->db->update("t_approval_itp_vendor", $data_squence);
  ...
  public function get_comp($id){
    ...
    LEFT JOIN m_vendor r ON r.ID_VENDOR=a.id_vendor
    LEFT JOIN m_user m ON m.ID_USER=q.create_by
    LEFT JOIN m_departement k ON k.ID_DEPARTMENT=m.ID_DEPARTMENT
    WHERE z.id_itp_vendor='".$id."'
